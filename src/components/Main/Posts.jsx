                    ...
                    <div className="row g-5">
                        <div className="col-lg-4">
                            <div className="post-entry-1 lg">
                                ...
                                <h2>
                                    <a href="single-post.html">
                                        11 Work From Home Part-Time Jobs You Can
                                        Do Now
                                    </a>
                                </h2>
                                <p className="mb-4 d-block">
                                    Lorem ipsum dolor sit, amet consectetur
                                    adipisicing elit. Vero temporibus
                                    repudiandae, inventore pariatur numquam
                                    cumque possimus exercitationem? Nihil
                                    tempore odit ab minus eveniet praesentium,
                                    similique blanditiis molestiae ut saepe
                                    perspiciatis officia nemo, eos quae cumque.
                                    Accusamus fugiat architecto rerum animi
                            ...
                            <div className="row g-5">
                                    ...
                                    <div className="post-entry-1">
                                        ...
                                        <h2>
                                            <a href="single-post.html">
                                                ...
                                                Stay Focused During Video Calls?
                                            </a>
                                        </h2>
                                    </div>
                                    <div className="post-entry-1">
                                        ...
                                        <h2>
                                            <a href="single-post.html">
                                                Why Craigslist Tampa Is One of
                                                The Most Interesting Places On
                                                the Web?
                                            </a>
                                        </h2>
                                    </div>
                                ...
                                <div className="col-lg-4 border-start custom-border">
                                    <div className="post-entry-1">
                                        ...
                                        <h2>
                                            <a href="single-post.html">
                                                6 Easy Steps To Create Your Own
                                                Cute Merch For Instagram
                                            </a>
                                        </h2>
                                    </div>
                                    <div className="post-entry-1">
                                        ...
                                        <h2>
                                            <a href="single-post.html">
                                                10 Life-Changing Hacks Every
                                                Working Mom Should Know
                                            </a>
                                        </h2>
                                    </div>
                                    <div className="post-entry-1">
